...
<body class="g-sidenav-show bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container-fluid py-2">
            ...
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addModal"><i class="fas fa-user-plus"></i> Add User</button>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $user['contact'] ?></td>
                        <td>
                            <button class="btn btn-warning" onclick='openUpdateModal(<?= json_encode($user) ?>)'><i class="fas fa-edit"></i> Update</button>
                            <button class="btn btn-danger" onclick="confirmDeleteUser(<?= $user['id'] ?>)"><i class="fas fa-trash"></i> Delete</button>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
            <a href="manage_residents.php?export=csv" class="btn btn-success"><i class="fas fa-file-csv"></i> Export to CSV</a>
            <a href="manage_residents.php?export=pdf" class="btn btn-primary"><i class="fas fa-file-pdf"></i> Export to PDF</a>
        </div>
    </main>
