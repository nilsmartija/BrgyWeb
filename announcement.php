...
<head>
    ...
    <title>Admin Dashboard - Manage Announcement</title>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="list-group" id="announcementList">
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<a href='announcement.php?delete_id=" . $row['id'] . "' class='btn btn-danger' onclick='return confirmDelete(event)'><i class='fas fa-trash'></i> Delete</a>";
                            echo "</div>";
                            echo "</div>";
                        }
                        ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="modalAnnouncementForm" action="announcement.php" method="POST">
                        ...
                        <button type="submit" class="btn btn-success" id="modalSubmitBtn"><i class="fas fa-check"></i> Add Announcement</button>
                    </form>
                </div>
            </div>
        </div>
