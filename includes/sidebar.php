<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2 bg-white my-2" id="sidenav-main" style="background: linear-gradient(180deg, #6a11cb 0%, #2575fc 100%); overflow: hidden; height: 100vh;">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo $current_page == 'manage_staff.php' ? 'active bg-gradient-dark text-white' : 'text-white'; ?>" href="../aadmin/manage_staff.php">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo $current_page == 'logout.php' ? 'active bg-gradient-dark text-white' : 'text-white'; ?>" href="../aadmin/logout.php">
