...
<head>
    ...
    <title>Admin Dashboard | Manage Blotter Reports</title>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <form id="assignForm_<?= $row['blotter_id'] ?>" class="me-2">
                                            ...
                                            <button type="button" class="btn btn-primary ms-2" onclick="confirmAssign(<?= $row['blotter_id'] ?>)">
                                                <i class="fas fa-calendar-check"></i> Assign
                                            </button>
                                        </form>
                                        <form id="cancelForm_<?= $row['blotter_id'] ?>" class="me-2">
                                            <input type="hidden" name="blotter_id" value="<?= $row['blotter_id'] ?>">
                                            <button type="button" class="btn btn-danger" onclick="confirmCancel(<?= $row['blotter_id'] ?>)">
                                                <i class="fas fa-times-circle"></i> Cancel
                                            </button>
                                        </form>
                                        <button type="button" class="btn btn-success" onclick="confirmComplete(<?= $row['blotter_id'] ?>)">
                                            <i class="fas fa-check-circle"></i> Finish Meeting
                                        </button>
                                    </div>
                                </td>
                            </tr>
